            ...
            <div class="loginform_container">
                ...
                <form action="./signup.php" method="POST">
                    <div class="mainform">
                        ...
                        <?php if($Error){ echo " value=$fullname";}?>
                         >
                        ...
                        <?php if($Error ){ echo " value=$birthday";}?>>
                        ...
                        <?php if($Error){ echo " value=$phonenumber";}?>
                        >
                    </div>
